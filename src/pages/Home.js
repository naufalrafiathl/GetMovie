...
function Home({history}) {
  ...
  const landing_api =
    "https://api.themoviedb.org/3/discover/movie?sort_by=popularity.desc&api_key=694f210a11567b3472a88c95b053d7e7&page=1";
  const img_api = "https://image.tmdb.org/t/p/w342";
  const search_api =
    "https://api.themoviedb.org/3/search/movie?api_key=694f210a11567b3472a88c95b053d7e7&query=";
  ...
  const { addMovieToLikes, likes, addMovieToBookmarks } =
    ...
    <>
      ...
      <div className="bg-container" id="home">
        ...
        <p className="hero-desc">
          Get movies details, save to your liked page, or add it to bookmark
        </p>
        <div className="btn-homepg">
          <Linkz
            ...
            duration={500}
          >
            <Button buttonColor="red" buttonSize="btn--wide">
              SEARCH NOW
            </Button>
          </Linkz>
        </div>
              ...
              <div key={movies.id} className="card-movie">
                  ...
                  <img
                    ...
                    src={
                      movies.poster_path
                        ...
                        : "https://image.winudf.com/v2/image/YXBwaW52ZW50b3IuYWlfY3VybHlrYXk5MTYubm90ZXh0d2hpbGVkcml2aW5nX3NjcmVlbl8xX2VraWs5ZjMy/screen-1.jpg?fakeurl=1&type=.jpg"
                    }
                    alt={movies.title}
                  />
                </div>
                <div className="card-info">
                  ...
                  <span className="rating-movie">
                    {movies.vote_average} Rated
                  </span>
                </div>
                <div className="container-like">
                  <Link to="/likes">
                    <Button
                      onClick={() => addMovieToLikes(movies)}
                      className="like-btn"
                      buttonColor="red"
                ...
                <div className="container-bm">
                  <Link to="/bookmark">
                    <Button
                      onClick={() => addMovieToBookmarks(movies)}
                      className="like-btn"
                      buttonColor="blue"
                      buttonSize="btn--small"
                      value={movies.id}
